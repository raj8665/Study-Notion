...
// start with capturing of payment and initiate the razorpay payment
...
exports.verifySignature = async (req, res) => {
        ...
        try{
            //verify the signature using HMAC which require an algorithm to converto to hashing and razorpay secret key 
...
//send email of successful payment
